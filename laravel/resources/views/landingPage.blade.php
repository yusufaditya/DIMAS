...
<div class="col">
    ...
    <div class="row">
        ...
        <div class=" col mt-5" id="smm">
            <div class="row">
                <div class="col text-center">
                    <img src="assets/img/web1.png" width="500" height="300">
                </div>
        ...
        <!-- End -->
        <!-- Building Websitem -->
        <div class=" col mt-5" id="bw" style="display: none;">
            <div class="row">
                <div class="col text-center">
                    <img src="assets/img/19199025.png" width="300" height="300">
                </div>
                <div class="col" style="margin-top: 40px;">
                    <div class="col text-center">
        ...
        <div class=" col mt-5" id="tp" style="display: none;">
            <div class="row">
                <div class="col text-center">
                    <img src="assets/img/3410348.jpg" width="500" height="300">
                </div>
                <div class="col" style="margin-top: 40px;">
                    <div class="col text-center">
        ...
        <div class=" col mt-5" id="sp" style="display: none;">
            <div class="row">
                <div class="col text-center">
                    <img src="assets/img/2473674.jpg.png" width="500" height="300">
                </div>
                <div class="col" style="margin-top: 40px;">
                    <div class="col text-center">
