        ...
        <div class="col">
            ...
            <div class="landing row mt-5 ">
                ...
                <div class="col-md-6 mt-5">
                    <center><img src="assets/img/webw.png" width="500" height="500"></center>
                </div>
            </div>
            <!-- End of vector -->
            ...
            <!-- Edukasi Digital Marketing -->
            <div class="filling row mt-5 " style="background-color: #58E4F7;">
                <div class=" text col-md-6 ">
                    ...
                    <div class="col-md-12 ml-4 mt-4 text-white" style="text-align: center;">
                ...
                <div class="col-md-6">
                    <img src="assets/img/web1.png" width="600" height="400">
                </div>
            </div>
            <!-- End Edukasi Digital Marketing -->
            <!-- VM -->
